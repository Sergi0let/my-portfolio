...
const allProjects: projectType[] = getMarkDownData('data/design-agency')
const projects = allProjects.filter((p) => p.featured === true)
        ...
        <div className="mb-10 flex flex-col items-start justify-center gap-x-10 gap-y-6 md:mb-20 md:flex-row md:items-end lg:justify-start">
          <div className="flex-1">
            <RevealWrapper className="rv-badge reveal-me">
              <span className="rv-badge-text">Pet Projects</span>
            </RevealWrapper>
            <TextAppearAnimation>
              <h2 className="text-appear mt-3 md:mt-5">
                Selected
                <span className="font-instrument italic"> Work</span>
              </h2>
            </TextAppearAnimation>
          </div>
          <div className="flex-1">
            <TextAppearAnimation>
              <p className="text-appear md:text-right">
                Personal projects built to explore new technologies, sharpen skills, and create real-world value.
              </p>
            </TextAppearAnimation>
