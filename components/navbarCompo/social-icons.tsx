...
export function SocialIcons() {
  return (
    <div className="flex gap-6">
      <span>
        <Link href="https://github.com/svashkevych" target="_blank" aria-label="GitHub">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="fill-[#565656] duration-200 hover:fill-white">
      ...
      <span>
        <Link href="https://www.linkedin.com/in/svash" target="_blank" aria-label="LinkedIn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <span>
        <Link href="https://t.me/serg_v6" target="_blank" aria-label="Telegram">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-[#565656] duration-200 hover:stroke-white"
            width="23"
